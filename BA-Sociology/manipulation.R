...
# Creating 5 subsets for each quarter year of the pandemic
...
listrkiaggr <- list(dfrkiaggr20.02,dfrkiaggr20.03,dfrkiaggr20.04,dfrkiaggr20.05,dfrkiaggr20.06,dfrkiaggr20.07,
                    ...
                    dfrkiaggr21.01,dfrkiaggr21.02,dfrkiaggr21.03,dfrkiaggr21.04)
...
dfrkiaggr$deathRate <- (dfrkiaggr$aggrDeaths / dfrkiaggr$population) * 100000
dfrkiaggr$deathRate20.02 <- (dfrkiaggr$aggrDeaths20.02 / dfrkiaggr$population) * 100000
dfrkiaggr$deathRate20.03 <- (dfrkiaggr$aggrDeaths20.03 / dfrkiaggr$population) * 100000
dfrkiaggr$deathRate20.04 <- (dfrkiaggr$aggrDeaths20.04 / dfrkiaggr$population) * 100000
dfrkiaggr$deathRate20.05 <- (dfrkiaggr$aggrDeaths20.05 / dfrkiaggr$population) * 100000
dfrkiaggr$deathRate20.06 <- (dfrkiaggr$aggrDeaths20.06 / dfrkiaggr$population) * 100000
dfrkiaggr$deathRate20.07 <- (dfrkiaggr$aggrDeaths20.07 / dfrkiaggr$population) * 100000
dfrkiaggr$deathRate20.08 <- (dfrkiaggr$aggrDeaths20.08 / dfrkiaggr$population) * 100000
dfrkiaggr$deathRate20.09 <- (dfrkiaggr$aggrDeaths20.09 / dfrkiaggr$population) * 100000
dfrkiaggr$deathRate20.10 <- (dfrkiaggr$aggrDeaths20.10 / dfrkiaggr$population) * 100000
dfrkiaggr$deathRate20.11 <- (dfrkiaggr$aggrDeaths20.11 / dfrkiaggr$population) * 100000
dfrkiaggr$deathRate20.12 <- (dfrkiaggr$aggrDeaths20.12 / dfrkiaggr$population) * 100000
dfrkiaggr$deathRate21.01 <- (dfrkiaggr$aggrDeaths21.01 / dfrkiaggr$population) * 100000
dfrkiaggr$deathRate21.02 <- (dfrkiaggr$aggrDeaths21.02 / dfrkiaggr$population) * 100000
dfrkiaggr$deathRate21.03 <- (dfrkiaggr$aggrDeaths21.03 / dfrkiaggr$population) * 100000
dfrkiaggr$deathRate21.04 <- (dfrkiaggr$aggrDeaths21.04 / dfrkiaggr$population) * 100000
...
dfdd$LNdeathRate20.02 <- log(dfdd$deathRate20.02)
dfdd$LNdeathRate20.03 <- log(dfdd$deathRate20.03)
dfdd$LNdeathRate20.04 <- log(dfdd$deathRate20.04)
dfdd$LNdeathRate20.05 <- log(dfdd$deathRate20.05)
dfdd$LNdeathRate20.06 <- log(dfdd$deathRate20.06)
dfdd$LNdeathRate20.07 <- log(dfdd$deathRate20.07)
dfdd$LNdeathRate20.08 <- log(dfdd$deathRate20.08)
dfdd$LNdeathRate20.09 <- log(dfdd$deathRate20.09)
dfdd$LNdeathRate20.10 <- log(dfdd$deathRate20.10)
dfdd$LNdeathRate20.11 <- log(dfdd$deathRate20.11)
dfdd$LNdeathRate20.12 <- log(dfdd$deathRate20.12)
dfdd$LNdeathRate21.01 <- log(dfdd$deathRate21.01)
dfdd$LNdeathRate21.02 <- log(dfdd$deathRate21.02)
dfdd$LNdeathRate21.03 <- log(dfdd$deathRate21.03)
dfdd$LNdeathRate21.04 <- log(dfdd$deathRate21.04)
dfdd$LNdeathRate <- log(dfdd$deathRate)
