...
dfIR.foreign <- SARvarlist3("GISDforeign","GISD","shareForeign",varlistLNIR, varlistControl)
...
dfCFR.foreign <- OLSvarlist3("GISDforeign","GISD","shareForeign",varlistLNIR, varlistControl)
displayCoeff(dfCFR.foreign,"LN IR ~ GISD * Share Foreigners, Regression Coefficients (OLS)", "Regression Coefficient")
dfCFR.foreign
...
dfIR.east <- SARvarlist3("GISDeast","GISD","east",varlistLNIR, varlistControl)
...
dfCFR.east <- OLSvarlist3("GISDeast","GISD","east",varlistLNIR, varlistControl)
displayCoeff(dfCFR.east,"LN IR ~ GISD * Share Foreigners, Regression Coefficients (OLS)", "Regression Coefficient")
dfCFR.east
